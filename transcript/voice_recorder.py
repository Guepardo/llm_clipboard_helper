...
class VoiceRecorder(Thread):
  ...
  HUMAN_VOICE_DETECTOR_SENSIBILITY = 0 # 0 (menos sensível) a 3 (mais sensível)
  ...
  def __init__(self):
    ...
    self.frames = []
    self.stream = None
    self.human_voice_detector = webrtcvad.Vad(self.HUMAN_VOICE_DETECTOR_SENSIBILITY)
  ...
  def stop(self):
    ...
    try:
        ...
        print(f"Erro ao parar/fechar stream: {e}")
